A Spotify Clone built using modern web technologies. This project replicates some core features of Spotify, such as music browsing, playlists, and an interactive UI.
